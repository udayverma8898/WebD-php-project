...
<head>
    ...
    <title>Contact - Caffè Java</title>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    ...
                    <p>Email:
                        <strong><a href="mailto:info@caffejava.com">info@caffejava.com</a></strong>
                    </p>
                    <p>Address:
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <p>Do join us for a cup of coffee. If you have any questions feel free to contact us.</p>
                    <form role="form">
                        <div class="row">
